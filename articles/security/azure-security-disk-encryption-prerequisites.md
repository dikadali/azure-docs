...
- Windows Server versions: Windows Server 2008 R2, Windows Server 2012, Windows Server 2012 R2, and Windows Server 2016.
    ...
    - For Windows Server Core versions, you must add bdehdcfg component which isn't available by default, see:[Troubleshooting Windows Server 2016 Server Core guide](https://docs.microsoft.com/en-us/azure/security/azure-security-disk-encryption-tsg#troubleshooting-windows-server-2016-server-core).
